...
const textstyle  = TextStyle(color: Colors.white70,fontSize: 30,fontWeight: FontWeight.bold);
const numstyle = TextStyle(color: Colors.white,fontWeight: FontWeight.bold, fontSize: 40);
